  ...
  const checkImgUrl = async () => {
    ...
    if (pokeState.pokemon?.forms[spriteType][spriteIdx].apiId) {
      if (isShiny) {
        ...
        fetch(`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/shiny/${pokeState.pokemon.forms[spriteType][spriteIdx].apiId}.png`)
          .then(res => {
